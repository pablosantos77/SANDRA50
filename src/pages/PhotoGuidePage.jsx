...
export default function PhotoGuidePage() {
  return (
    <main className="mx-auto min-h-screen max-w-4xl px-4 pb-28 pt-8">
      <article className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-black/5 md:p-10 prose prose-neutral max-w-none">
        <h1 className="text-3xl font-bold tracking-tight md:text-4xl mb-6">Guía: Cómo hacer fotos épicas en eventos</h1>
        ...
        <h3 className="text-xl font-bold mt-8 mb-4">1. Aprovecha la luz natural y estabiliza el móvil</h3>
        ...
        <h3 className="text-xl font-bold mt-8 mb-4">2. Cuida el encuadre y acércate</h3>
        <p className="text-base leading-8 text-neutral-700">
        ...
        <h3 className="text-xl font-bold mt-8 mb-4">3. Captura la naturalidad</h3>
        <p className="text-base leading-8 text-neutral-700">
        ...
        <h3 className="text-xl font-bold mt-8 mb-4">4. Evita los excesos y limpia la lente</h3>
        <p className="text-base leading-8 text-neutral-700">
        ...
        <h3 className="text-xl font-bold mt-8 mb-4">5. Sube las mejores, no todas</h3>
        <p className="mt-4 text-base leading-8 text-neutral-700">
